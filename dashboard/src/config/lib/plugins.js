...
import  {
  ...
  Cascader, Checkbox, Col, DatePicker, Divider, Dropdown, Form, Input, InputNumber, Layout, List, LocaleProvider,
...
export function setUpPlugins (app) {
  ...
  app.use(Cascader).use(Checkbox).use(Col).use(DatePicker).use(Divider).use(Dropdown).use(Form).use(Input).use(InputNumber).use(Layout).use(List).use(LocaleProvider)
